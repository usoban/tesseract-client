...
export class DoubleLinkedList {
    ...
    */
    ...
    insertAfter(afterNode, value) {
        let currentNextNode = afterNode.next, nextNode = new Node(value, afterNode, currentNextNode);
    ...
    insertAfterAndDisposeTail(afterNode, value) {
        let newTailNode;
        if (afterNode === null) {
            afterNode = this.head;
        }
    ...
    */
    ...
    length() {
        let node = this.head.next, count = 0;
        while (node !== null) {
            count++;
            node = node.next;
        }
